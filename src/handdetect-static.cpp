	...
	while(isRunning)
   	{
		...
		drawContours(colorImage,contours,-1,Scalar(0,0,255),2);
		  ...
		  for( int i = 0; i < contours.size(); i++ )
			...
			// Boundary Dectation
			if( mc[i].x <= 200.0 &&  mc[i].y <= 240.0)
			{
				count_position[0] ++;
				cout << "got it!!!!!!!!!!!!!!!!!!!!!!!!!";
			}
			else if( mc[i].x <= 200.0 &&  mc[i].y >= 240.0)
			{
				count_position[1] ++;
				cout << "got it!!!!!!!!!!!!!!!!!!!!!!!!!!";
			}
			else if( mc[i].x >= 440.0 && mc[i].y <= 240.0)
			{
				count_position[2] ++;
				cout << "got it!!!!!!!!!!!!!!!!!!!!!!!";
			}
			...
			// send ir command here
			if ( count_position[0] == 4)
			{
				myfile << "1111111111111111111111"<<"\n";
				cout << "writin' it!!!!!!!!!!!!!!!!!";
			...
			else if ( count_position[1] == 4)
			{
				myfile << "2222222222222222222222\n";
				cout << "writin' it!!!!!!!!!!!!!!!!!!!!!!!";
				for( i = 0; i < 4; i++)
				{
					count_position[i] = 0;
			...
			else if ( count_position[2] == 4)
			{
				myfile << "3333333333333333333333\n";
				cout << "writin' it!!!!!!!!!!!!!!!!!!!!!";
				for( i = 0; i < 4; i++)
				{
					count_position[i] = 0;
			...
			else if ( count_position[3] == 4)
			{
				myfile << "4444444444444444444444\n";
				cout << "writin' it!!!!!!!!!!!!!!!!!!!!!";
				for( i = 0; i < 4; i++)
				{
					count_position[i] = 0;
